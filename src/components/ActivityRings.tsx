        ...
        return (
          <g key={i}>
            ...
            <motion.circle
              ...
              transition={{ duration: 1.1, ease: [0.22, 1.2, 0.36, 1], delay: i * 0.1 }}
            />
                ...
                <g filter={`url(#glow-${i})`}>
                  ...
                  {spikes.map((s, k) => (
                    <motion.line
                      ...
                      transition={{ duration: 0.45, ease: 'easeOut', delay: i * 0.1 + 0.75 }}
                    />
                  ))}

                  {/* Outer glow halo */}
                  <motion.circle
                    cx={head.x} cy={head.y} r={0}
                    fill={ring.color}
                    fillOpacity={0.2}
                    animate={{ r: HEAD_R + 4 }}
                    transition={{ duration: 0.4, ease: 'easeOut', delay: i * 0.1 + 0.7 }}
                  />
                  ...
                  <motion.circle
                    ...
                    fill={ring.color}
                    animate={{ r: HEAD_R }}
                    transition={{ duration: 0.35, ease: [0.34, 1.56, 0.64, 1], delay: i * 0.1 + 0.72 }}
                  />
                </g>
              )
            })()}
